			...
			return qa.prototype = d.filters = d.pseudos, d.setFilters = new qa, g = fa.tokenize = function (a, b) {
				...
				if (c = c || [], 1 === n.length) {
					...
					for (f = V.needsContext.test(a) ? 0 : i.length; f-- && (j = i[f], !d.relative[k = j.type]);)
						if ((l = d.find[k]) && (e = l(j.matches[0].replace(_, aa), $.test(i[0].type) && pa(b.parentNode) || b))) {
							if (i.splice(f, 1), !(a = e.length && ra(i))) return G.apply(c, e), c;
							break
						}
				}
				return (m || h(a, n))(e, b, !p, c, !b || $.test(a) && pa(b.parentNode) || b), c
...
, function (a, b, c) {
	...
	a.fn.scrollUp = function (b) {
		...
		var e, f, g, h, j, k, l = a.fn.scrollUp.settings = a.extend({}, a.fn.scrollUp.defaults, d)
			, m = !1;
		...
		h = "top" === l.scrollFrom ? l.scrollDistance : a(c).height() - a(b).height() - l.scrollDistance, a(b).scroll(function () {
